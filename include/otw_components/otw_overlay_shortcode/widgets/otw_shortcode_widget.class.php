...
class OTW_Shortcode_Widget extends WP_Widget{
	...
	function __construct(){
		...
		parent::__construct( 'otw_shortcode_widget', __('OTW Shortcode Widget', 'otw_pcl' ) );
	}
	...
	public function form( $instance ){
		...
		$output .= "\n<div class=\"otw-ws-content\">";
			$output .= "\n<div id=\"".$this->get_field_id( 'otw-sw-controls' )."\">";
				$output .= "\n<label for=\"".$this->get_field_id( 'otw-shortcode-type' )."\">".__( 'Select Shortcode', 'otw_pcl' )."</label><br />";
				...
				$output .= "\n</select>";
				$output .= "&nbsp;<input type=\"button\" value=\"".__( 'Add', 'otw_pcl' )."\" class=\"button button-primary\" id=\"".$this->get_field_id( 'otw-sw-add-shortcode' )."\" onclick=\"otw_sw_add_shortcode( this );\"/>";
			$output .= "\n</div>";
